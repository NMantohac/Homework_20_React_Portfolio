          ...
          <Grid.Column style={{ maxWidth: 1000 }}>
            <Segment textAlign="center" style={{ marginLeft: '5em 0em', backgroundColor: 'silver' }}>
              ...
              <Grid textAlign="left" verticalAlign="middle">
                <Grid.Row columns={2}>
                  <Grid.Column width={4}>
                    <Image src={pfp1} height="250" width="250" style={{ marginLeft: '20px' }} />
                  </Grid.Column>
                  <Grid.Column width={12}>
                    ...
                    <p style={{ fontSize: '20px' }}>Little did I know that my interest grew into a passion during the time I was in the the UC Berkeley Extension Web Development Bootcamp. After I graduated from the program, I have continued to sharpen my skils as a Full-Stack Developer and have been starting to look into more languages such as Java/Python/C++/etc.</p>
                  </Grid.Column>
                </Grid.Row>
              </Grid>
              <Grid textAlign="left">
